function p = ODP1estimateInterp(p)
...
p.level(curLvl).P2DWRu4e = @P2DWRInterpolation;
dnu_T = integrate(n4e,curLvl,4*degree,@funcHandleEigenvalueWeightElems,p);
dnu_E = integrate(n4ed,curLvl,4*degree,@funcHandleEigenvalueWeightEdges,p);
