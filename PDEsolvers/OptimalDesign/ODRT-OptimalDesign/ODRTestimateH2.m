...
% dual jumps
dnu_E = integrate(n4ed,curLvl,degree,@NormalJumpGradU,p);
...
function val = NormalJumpGradU(x,y,curEdge,lvl,p)
grad_h = p.statics.grad_h;%GradU_h;
e4ed = p.level(lvl).enum.e4ed;
normals4ed = p.level(lvl).enum.normals4ed;
