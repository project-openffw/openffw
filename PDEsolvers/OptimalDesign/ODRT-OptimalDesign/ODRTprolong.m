...
DWRsigma_h = loadField('p.statics.','DWRsigma_h',p,sigma_h);
u_h = p.statics.u_h;
DWRu_h = loadField('p.statics.','DWRu_h',p,u_h);

x0 = loadField('p.epsilon(end).','x0',p);
DWRx0 = loadField('p.epsilon(end).','DWRx0',p,x0);
