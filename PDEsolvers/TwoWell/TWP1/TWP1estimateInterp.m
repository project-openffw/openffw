...
p = P2PWRInterpolation(p,curLvl);
dnu_T = integrate(n4e,curLvl,4*degree,@TWPWRfuncHandleWeightElems,p);
dnu_E = integrate(n4ed,curLvl,4*degree,@TWPWRfuncHandleWeightEdges,p);
