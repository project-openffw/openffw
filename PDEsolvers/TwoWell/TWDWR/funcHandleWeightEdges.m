...
curU_P1  = getU_h4e(x,y,elems,curLvl,p)';           
...
%uh = p.level(lvl).DWRu4e;
%curU = uh(parts);
%u = repmat(curU,length(x),1);
u = p.level(lvl).P2DWRu4e(x,y,parts,lvl,p);
...
basisU = P1Basis4e(pts,pts_ref,parts,lvl,p);%*...
%    [ 1 0 0 -2  0 -2 
%      0 1 0 -2 -2  0
%      0 0 1  0 -2 -2
%      0 0 0  4  0  0
...
%%
function basisP1 = P1Basis4e(x,y,curElem,lvl,p)
