...
if lvl > 2
    ...
    for curEdge = 1:nrEdges
        ...
        lambda14T1 = lambda1(midPoint(1),midPoint(2),parents(1),lvl-1,p)*normal1';
        lambda14T2 = lambda1(midPoint(1),midPoint(2),parents(2),lvl-1,p)*normal1';
    ...
    for curElem = 1:nrElems
        ...
        curLambda = lambda2(midPoint(1),midPoint(2),parent,lvl-1,p);
