...
if(nargin < 3)
	error('You have to specify a the type of error ''(i.e. approxL2error)''');
end
...
minDoF = loadField('p.params.output','minDoF',p,ceil(maxNrDoF/17));
...
setScales = loadField('p.params.output','setScales',p,true);
