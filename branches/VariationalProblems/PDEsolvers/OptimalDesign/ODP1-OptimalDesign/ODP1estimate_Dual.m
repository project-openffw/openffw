...
%    tau(curElem,:) = -[0 midPoint4e(curElem,2)];
    ...
    if (absTau ~= 0)
        evalDW_eps = DW_eps(absTau,curElem,lvl,p)./absTau;
    else
        evalDW_eps = 0;
    end
%    evalDW(curElem,:) = evalDW_eps*ones(1,2);
