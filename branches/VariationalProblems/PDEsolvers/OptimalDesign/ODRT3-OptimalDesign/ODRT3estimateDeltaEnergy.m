...
if strcmp(problem,'OptimalDesign_SquareSlit') % SquareSlit
    EnMid = -0.125396464767975/4; %Aitken 3256 P0-RT0
%    EnMid = -0.128333827260278/4; %Aitken 3256 P0-RT0
    sigmaSqL2A = 0.329480291755864; %Aitken 3256 P0-RT0
elseif strcmp(problem,'OptimalDesign_SquareSlit_exact') % SquareSlit exact
    EnMid = 0.1/4; %Aitken 3256 P0-RT0
    sigmaSqL2A = 0.1; %Aitken 3256 P0-RT0
elseif strcmp(problem,'OptimalDesign_Lshape') % Lshape
    EnMid = -0.0984192918060962/3; %Aitken 3904 P0-RT0
    sigmaSqL2A = 0.215778470993084; %Aitken
else % Lshape exact
    EnMid = 0.1/3; %Aitken
    sigmaSqL2A = 0.1; %Aitken
end
