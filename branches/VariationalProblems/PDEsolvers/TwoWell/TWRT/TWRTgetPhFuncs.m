...
[evalConjNonLinear_x evalConjNonLinear_y] = conjNonLinearFuncDer(evalSigmah(:,1),evalSigmah(:,2),curElem,lvl,p);
evalConjNonLinear = [evalConjNonLinear_x evalConjNonLinear_y];
grad_h = (evalConjNonLinear).*evalSigmah;
