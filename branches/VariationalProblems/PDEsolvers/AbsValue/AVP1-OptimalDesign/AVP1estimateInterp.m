function p = AVP1estimateInterp(p)
...
dnu_T = integrate(n4e,curLvl,4*degree,@AVPWRfuncHandleWeightElems,p);
dnu_E = integrate(n4ed,curLvl,4*degree,@AVPWRfuncHandleWeightEdges,p);
