function p = Elliptic_Exact_Polar_Template(p)
...
syms r theta kappa lambda mu real
...
DiffKappaGradU = [diff(KappaGradU(1),r) diff(KappaGradU(1),theta);
                      diff(KappaGradU(2),r) diff(KappaGradU(2),theta)]';
