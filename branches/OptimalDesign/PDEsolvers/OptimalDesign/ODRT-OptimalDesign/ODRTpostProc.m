...
for curElem = 1:nrElems
    ...
    evalBasisP1 = stressBasis(P1,curElem,lvl,p);
    evalBasisP2 = stressBasis(P2,curElem,lvl,p);
    evalBasisP3 = stressBasis(P3,curElem,lvl,p);
...
function val = phminusAph(points,curElem,lvl,p)

sigma_h = p.statics.sigma_h;
Asigma_h = p.statics.Ap_h;

Asigmah = Asigma_h(points,curElem,lvl,p);
...
function evalEnergy = getConjEnergy(points,curElem,lvl,p)
