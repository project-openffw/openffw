...
<!-- BEGIN input -->
<h2><a name="_input"></a>INPUT <a href="#_top"><img alt="^" border="0" src="{MASTERPATH}up.png"></a></h2>
<div class="fragment"><pre>{INPUT}</pre></div>
<!-- END input -->

<!-- BEGIN output -->
<h2><a name="_output"></a>OUTPUT <a href="#_top"><img alt="^" border="0" src="{MASTERPATH}up.png"></a></h2>
<div class="fragment"><pre>{OUTPUT}</pre></div>
<!-- END output -->
