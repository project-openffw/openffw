function p = drawMarkedBeforeClosureGrid(p,lvl)
% draw the edges that are marked before closure
...
markedEdgesBeforeClosure = p.level(lvl).markedEdgesBeforeClosure;
...
for j = find(markedEdgesBeforeClosure)
