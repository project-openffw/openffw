...
p4n = getP4n(Db,DbEd,e4n,e4ed,n4e,nrNodes,nrElems);
[wp4n,Iz] = getWP4n(Db,DbEd,e4n,e4ed,n4e,nrNodes,nrElems);

%%% OUTPUT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
p.level(end).enum.ed4n = ed4n;
p.level(end).enum.ed4e = ed4e;
p.level(end).enum.e4n = e4n;
p.level(end).enum.p4n = p4n;
p.level(end).enum.wp4n = wp4n;
p.level(end).enum.Iz4n = Iz;
